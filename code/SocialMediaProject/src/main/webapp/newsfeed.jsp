						...
						<div class="row merged20" id="page-contents">
								...
								<div class="central-meta postbox">
									...
									<div class="new-postbox">
										...
										<div class="newpst-input">
											<form method="post">
												<textarea rows="2" placeholder="Hôm nay bạn đang nghĩ gì?"></textarea>
											</form>
										</div>
										<div class="attachments">
											<ul>
												...
												<li class="preview-btn">
													<button class="post-btn-preview" type="submit" data-ripple="">Xem trước</button>
												</li>
											</ul>
										...
										<div class="user-post">
											<div class="friend-info">
												...
												<div class="friend-name">
													...
													<ins><a href="time-line.html" title="">Jack Carter</a> Đăng album</ins>
													<span><i class="fa fa-globe"></i> Đã đăng: 15/05/2021 19:27PM </span>
												</div>
												<div class="post-meta">
													<p>
													...
													<div class="we-video-info">
														...
														<div class="users-thumb-list">
															...
															<span><strong>Bạn</strong>, <b>Sarah</b> và <a href="#" title="">24 người khác </a> thích bài</span>
														</div>
													</div>
												</div>
							...
							<div class="col-lg-3">
								<aside class="sidebar static right">
									<div class="widget">
										...
										<div class="your-page">
											...
											<div class="page-meta">
												...
												<span><i class="ti-bell"></i><a href="insight.html" title="">Thông báo <em>2</em></a></span>
											</div>
											...
											<div class="page-likes">
												<ul class="nav nav-tabs likes-btn">
													<li class="nav-item"><a class="active" href="#link1" data-toggle="tab" data-ripple="">Thích</a></li>
													 <li class="nav-item"><a class="" href="#link2" data-toggle="tab" data-ripple="">Xem</a></li>
												</ul>
												<!-- Tab panes -->
												<div class="tab-content">
												  <div class="tab-pane active fade show " id="link1" >
													<span><i class="ti-heart"></i>884</span>
													  <a href="#" title="weekly-likes">35 lượt thích mới trong tuần</a>
													  <div class="users-thumb-list">
									...
									<div class="widget">
										<h4 class="widget-title">Sự kiện <a title="" href="#" class="see-all">Xem tất cả</a></h4>
